...
#ifndef CG_RENDER_BUFFER
#define CG_RENDER_BUFFER
struct RenderBuffer
{
	HANDLE   hResource;
	uint64_t CpuDescriptor;
};
#endif // CG_RENDER_BUFFER
...
enum INPUT_ELEMENT_FORMAT
{
	...
	INPUT_ELEMENT_FORMAT_XY_32F = 1,
	INPUT_ELEMENT_FORMAT_XYZ_8F = 2, INPUT_ELEMENT_FORMAT_RGB_8F = 2,
	INPUT_ELEMENT_FORMAT_XYZ_16F = 3, INPUT_ELEMENT_FORMAT_RGB_16F = 3,
	INPUT_ELEMENT_FORMAT_XYZ_32F = 4, INPUT_ELEMENT_FORMAT_RGB_32F = 4,
	INPUT_ELEMENT_FORMAT_XYZW_8F = 5, INPUT_ELEMENT_FORMAT_RGBA_8F = 5,
	INPUT_ELEMENT_FORMAT_XYZW_16F = 6, INPUT_ELEMENT_FORMAT_RGBA_16F = 6,
	INPUT_ELEMENT_FORMAT_XYZW_32F = 7, INPUT_ELEMENT_FORMAT_RGBA_32F = 7,
};
